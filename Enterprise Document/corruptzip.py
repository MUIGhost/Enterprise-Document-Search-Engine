...
# Custom configuration for corrupt files from environment variables
CORRUPT_DIR = os.environ.get("CORRUPT_FILES_DIR", os.path.join(tempfile.gettempdir(), "corruptedfiles"))
CORRUPT_ZIP_PATH = os.path.join(CORRUPT_DIR, "corrupt_files.zip")

# Ensure corrupt directory exists
